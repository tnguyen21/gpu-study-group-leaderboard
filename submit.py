...
def main():
    parser = argparse.ArgumentParser(
        description="Submit CUDA kernels to the GPU Kernel Leaderboard"
    )
    ...
    submit_parser.add_argument(
        "--user", "-u",
        default=os.environ.get("LEADERBOARD_USER", "anonymous"),
        help="Your username (or set LEADERBOARD_USER env var)"
    )
